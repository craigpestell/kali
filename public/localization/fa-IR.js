module.exports = {
    generic: {
        ...
        DATE: 'تاریح',
        HOME: 'خانه',
        BACK_HOME: 'برگرد به خانه',
        WRITER: 'نویسنده',
        READER: 'خواننده',
        EDITOR: 'ویرایشگر',
        MANAGING_EDITOR: 'مدیر ویراستار',
        ADMINISTRATOR: 'مدیریت',
        COLUMN_INCHES: 'اینچ ستون',
        CONTENT: 'محتوا',
        META_DATA: 'متا دیتا',
        SEO: 'SEO',
        FORM_INCOMPLETE: 'فرم ناقص است.',
        INVALID_UID: 'شناسه یکتای اشتباهی ارایه شده.',
        ERROR_SAVING: 'ایرادی در ذخیره سازی وجود دارد.',
        ERROR_DELETING: 'ایرادی در حذف وجود دارد.',
        INSUFFICIENT_CREDENTIALS: 'شما اجازه انجام این کار را ندارید.',
        SAVE: 'ذخیره',
        ...
        SORT: 'مرتب سازی',
        NOW: 'الان',
        CONFIRM_DELETE: 'آیا مطمین هستید که میخواهید حذف کنید؟',
        LOAD_FILE: 'بارگذاری فایل',
        SELECT_FILE: 'انتخاب فایل',
        NO_ARTICLES: 'هیچ مقاله ای منطبق با محدودیات ارایه شده یافت نشد',
        ACCOUNT: 'حساب',
        EMAIL: 'ایمیل',
        PREFERENCES: 'ترجیحات',
        COMMENT: 'نظر',
        ...
        LOGIN_TO_COMMENT: 'برای نظر دادن وارد شوید',
        COMMENT_SUBMITTED: 'نظر شما ارسال شد.',
        COMMENT_ERROR: 'ایرادی در ارسال نظر شما وجود دارد.',
        DATE_ADDED: 'تاریخ اضافه کردن',
        LAST_MODIFIED: 'تاریخ آخیرین تغییر.',
        CHECK: 'چک',
        AVAILABLE: 'موجود',
        UNAVAILABLE: 'ناموجود',
    	INSTALLED_ON: 'نصب شده در',
		VERSION: 'نسخه',
		ACTIVE_PLUGINS: 'افزونه های فعال',
		INACTIVE_PLUGINS: 'افزونه های غیر فعال',
		AVAILABLE_PLUGINS: 'افزونه های موجود',
		RESET_SETTINGS: 'تنظیمات اولیه',
		UNINSTALL: 'حذف نصب',
		INSTALL: 'نصب',
    ...
    admin: {
        ...
        TOPICS: 'موضوعات',
        MEDIA: 'رسانه',
        CUSTOM_OBJECTS: 'اشیا سفارشی',
        PLUGINS: 'افزونه ها',
        THEMES: 'قالب ها',
        LAYOUT: 'ساختار ها',
        FRONTEND: 'فزونه های ظاهر',
        BACKEND: 'افزونه های باطن',
        INSTALL_PLUGIN: 'نصب یک افزونه',
        USERS: 'کاربرها',
        SETTINGS: 'تنظیمات',
        VIEW_SITE: 'نمایش سایت',
        SITE_SETTINGS: 'تنطیمات سایت',
        SITE_LOGO: 'آرم سایت',
        AUTHOR: 'نویسنده',
        ACCOUNT: 'حساب',
